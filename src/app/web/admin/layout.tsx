                ...
                <header className="topbar" data-navbarbg="skin6">
                    <nav className="navbar top-navbar navbar-dark">
                        <div className="navbar-header" data-logobg="skin6">
                            <a
                                className="nav-toggler waves-effect waves-dark d-block d-md-none"
                            ...
                            <div className="navbar-brand">
                                ...
                                <b
                                    ...
                                    style={{ paddingTop: '3px', paddingRight: '50px' }}
                                >
                                    IPstress
                                </b>
                            </div>
                            ...
                            <ul className="navbar-nav float-right">
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                        <a className="dropdown-item" href="/web/admin/tickets">
                                            Inbox
                                        </a>
                                        <a className="dropdown-item" href="/web/profile">
                                            Profile
                                        </a>
                                        <div className="dropdown-divider"></div>
                                        <a className="dropdown-item" href="/web/api/auth/logout">
                                            Logout
                                        </a>
                                    </div>
                                </li>
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/attacklogs">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-wifi-off feather-icon"
                                        >
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/loginlogs">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-user feather-icon"
                                        >
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/news">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-plus feather-icon"
                                        >
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/settings">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-arrow-up-circle feather-icon"
                                        >
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/servers">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-shield feather-icon"
                                        >
                                ...
                                <li className="sidebar-item">
                                    <Link className="sidebar-link" href="/web/admin/hub">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-power feather-icon"
                                        >
