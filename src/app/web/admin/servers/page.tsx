    ...
    <>
      <div className="page-breadcrumb">
        <div className="d-flex align-items-center">
          <h4 className="page-title text-truncate text-white font-weight-medium mb-0">API Server Management</h4>
          ...
          <div className="col-md-5">
            <div className="card">
              <div className="card-body">
                ...
                <form method="POST" action="/web/api/admin/servers" className="mt-4">
                  ...
                  <div className="form-group">
                    ...
                    <input className="form-control" name="slots" type="number" defaultValue="10" required />
                  </div>
                  <div className="form-group">
                    <label className="text-white">Methods</label>
                    <input className="form-control" name="methods" defaultValue="UDP,TCP" />
                  </div>
              ...
              <div className="card-body">
                ...
                <div className="table-responsive mt-4">
                  <table className="table">
                    ...
                    <tbody>
                      {servers.length === 0 ? (
                        <tr><td colSpan={6} className="text-center text-muted">No servers added yet.</td></tr>
                      ) : (
                        servers.map((s) => (
                          <tr key={s.id}>
                            <td>{s.id}</td>
                            ...
                            <td>{s.methods}</td>
                            <td>
                              <form method="POST" action="/web/api/admin/servers" style={{ display: 'inline' }}>
                                <input type="hidden" name="action" value="delete" />
                                <input type="hidden" name="id" value={s.id} />
                                <button type="submit" className="btn btn-sm btn-danger" onClick={(e) => { if (!confirm('Delete this server?')) e.preventDefault(); }}>
                                  Delete
                                </button>
                              </form>
                            </td>
