                                ...
                                >
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            name="cooldown"
                                            type="number"
                                            defaultValue={settings?.cooldown || 0}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            name="cooldownTime"
                                            type="number"
                                            defaultValue={settings?.cooldownTime || 0}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            name="maxattacks"
                                            type="number"
                                            defaultValue={settings?.maxattacks || 0}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            name="testboots"
                                            type="number"
                                            defaultValue={settings?.testboots || 0}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <select
                                            className="form-control"
                                            name="maintaince"
                                            defaultValue={settings?.maintaince || ''}
                                        >
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            className="form-control"
                                            name="rotation"
                                            defaultValue={String(settings?.rotation || 0)}
                                        >
                                ...
                                >
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="form-control"
                                            name="stripePubKey"
                                            defaultValue={settings?.stripePubKey || ''}
                                        />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            className="form-control"
                                            name="stripe"
                                            defaultValue={String(settings?.stripe || 0)}
                                        >
                                            <option value="0">Off</option>
                                            <option value="1">On</option>
                                        </select>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="form-control"
                                            name="coinpayments"
                                            defaultValue={settings?.coinpayments || ''}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="form-control"
                                            name="ipnSecret"
                                            defaultValue={settings?.ipnSecret || ''}
                                        />
                                    </div>
                                    <button type="submit" className="btn btn-primary">
                                ...
                                >
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="form-control"
                                            name="issuerId"
                                            defaultValue={settings?.issuerId || ''}
                                        />
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <input
                                            className="form-control"
                                            name="google_site"
                                            defaultValue={settings?.google_site || ''}
                                        />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select
                                            className="form-control"
                                            name="cloudflare"
                                            defaultValue={String(settings?.cloudflare || 0)}
                                        >
                                            <option value="0">Off</option>
                                            <option value="1">On</option>
                                        </select>
