                                            ...
                                            {users.length === 0 ? (
                                                ...
                                                users.map((u) => (
                                                    <tr key={u.ID}>
                                                        ...
                                                        <td>
                                                            <span
                                                                className={`badge ${u.status === 1 ? 'badge-danger' : 'badge-success'}`}
                                                            >
                                                                {u.status === 1
                                                                    ? 'Banned'
                                                                    : 'Active'}
                                                        ...
                                                        <td>
                                                            ...
                                                            >
                                                                ...
                                                                <button
                                                                    type="submit"
                                                                    className={`btn btn-sm ${u.status === 1 ? 'btn-success' : 'btn-warning'} mr-1`}
                                                                >
                                                                    {u.status === 1
                                                                        ? 'Unban'
                                                                        : 'Ban'}
