                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb m-0 p-0">
                                ...
                                <li className="breadcrumb-item text-muted">
                                    <a href="/web/admin/tickets">Tickets</a>
                                </li>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <p className="text-muted">
                                    ...
                                    {new Date(ticket.date * 1000).toLocaleString()} | Status:{' '}
                                    <span
                                        className={`badge ${ticket.status === 'Closed' ? 'badge-secondary' : 'badge-warning'}`}
                                    >
                                        {ticket.status}
                                    </span>
                                </p>
