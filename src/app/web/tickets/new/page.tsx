    ...
    <>
      <div className="page-breadcrumb">
        <div className="d-flex align-items-center">
          <h4 className="page-title text-truncate text-white font-weight-medium mb-0">New Ticket</h4>
          <div className="ml-auto">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb m-0 p-0">
                <li className="breadcrumb-item text-sql" aria-current="page">IPstress</li>
                <li className="breadcrumb-item text-muted" aria-current="page">New Ticket</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div className="card-body">
                ...
                <div className="mt-4 activity">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      <label className="text-white" htmlFor="content">Message</label>
                      <textarea
                        className="form-control"
                        id="content"
                        name="content"
