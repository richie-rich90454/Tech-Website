      ...
      <>
        <div className="page-breadcrumb">
          <div className="d-flex align-items-center">
            <h4 className="page-title text-truncate text-white font-weight-medium mb-0">Ticket Not Found</h4>
          </div>
        </div>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-body">
                  <p className="text-muted">The requested ticket does not exist.</p>
                  <a href="/web/tickets" className="btn btn-primary">Back to Tickets</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="card bg-dark mb-3">
                  <div className="card-body">
                    <div className="d-flex">
                      <div>
                        <h6 className="text-white mb-1">{ticket.username}</h6>
                ...
                {messages.map((msg) => (
                  <div key={msg.messageid} className="card bg-dark mb-3">
                    <div className="card-body">
                      <div className="d-flex">
                        <div>
                          <h6 className="text-white mb-1">{msg.sender}</h6>
                          <p className="text-muted mb-0" style={{ whiteSpace: 'pre-wrap' }}>
                            {msg.content}
                          </p>
                          <small className="text-muted">
                ...
                {ticket.status !== 'Closed' && (
                  <div className="card bg-dark">
                    <div className="card-body">
                      ...
                      <form action={`/web/api/tickets/${ticket.id}`} method="POST">
