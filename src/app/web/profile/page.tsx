                    ...
                    <div className="ml-auto">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb m-0 p-0">
                                <li className="breadcrumb-item text-sql active" aria-current="page">
                                    IPstress
                                </li>
                                        ...
                                        <>
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    value={
                                                        userData.referral
                                                            ? `https://ipstress.com/register?ref=${userData.referral}`
                                                            : 'N/A'
                                                    }
                                                />
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <form method="post" action="/web/api/profile/password">
                                                <div className="form-group">
                                                    <label className="text-white" htmlFor="old">
                                                        Current Password
                                                    </label>
                                                    <input
                                                        className="form-control"
                                                ...
                                                <div className="form-group">
                                                    <label className="text-white" htmlFor="new">
                                                        New Password
                                                    </label>
                                                    <input
                                                        className="form-control"
                                                ...
                                                <div className="form-group">
                                                    <label className="text-white" htmlFor="rnew">
                                                        Repeat New Password
                                                    </label>
                                                    <input
                                                        className="form-control"
