                        ...
                        <nav className="sidebar-nav">
                            <ul id="sidebarnav">
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/dashboard">
                                        Dashboard
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/hub">
                                        Hub
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/plan">
                                        Plans
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/tickets">
                                        Tickets
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/giftcards">
                                        Gift Cards
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/affiliate">
                                        Affiliate
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/profile">
                                        Profile
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/wheel">
                                        Wheel
                                    </a>
                                </li>
                                <li className="sidebar-item">
                                    <a className="sidebar-link" href="/web/logout">
                                        Logout
                                    </a>
                                </li>
                            </ul>
