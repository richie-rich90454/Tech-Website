    ...
    <>
      <div className="page-breadcrumb">
        <div className="d-flex align-items-center">
          <h4 className="page-title text-truncate text-white font-weight-medium mb-0">Affiliate</h4>
          <div className="ml-auto">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb m-0 p-0">
                <li className="breadcrumb-item text-sql" aria-current="page">IPstress</li>
                <li className="breadcrumb-item text-muted" aria-current="page">Affiliate</li>
              </ol>
            </nav>
          </div>
        </div>
                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <div className="form-group">
                        ...
                        <p className="text-white font-weight-medium">{stats.referralCount}</p>
                      </div>
                      <div className="form-group">
                        <label className="text-white">Balance</label>
                        <p className="text-white font-weight-medium">{stats.referralBalance}¥</p>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div className="card-body">
                ...
                <div className="mt-4 activity">
                  <form onSubmit={handleWithdraw}>
                    <div className="form-group">
                      <label className="text-white" htmlFor="paymentMethod">Payment Method</label>
                      <select
                        className="form-control"
                        id="paymentMethod"
                    ...
                    <div className="form-group">
                      <label className="text-white" htmlFor="paymentAddress">Payment Address</label>
                      <input
                        className="form-control"
                        id="paymentAddress"
                        type="text"
