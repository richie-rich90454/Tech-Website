            ...
            <div className="col-xl-6 col-lg-6 col-md-12">
              <div className="banner_content">
                ...
                <ul className="btn_list">
                  <li>
                    <Link className="theme_btn wow fadeInUp animated" href="/web/register">
                      Register
                    </Link>
                  </li>
                  <li>
                    <Link className="theme_btn b-btn wow fadeInUp animated" data-wow-delay="0.3s" href="/web/login">
                      Log in
                    </Link>
                  </li>
                </ul>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="footer_widget">
                <h5>IPstress</h5>
                <p>L7 / L4 stress testing with a focus on reliability and clean reporting.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="footer_widget">
                ...
                <ul className="cta_list">
                  <li><Link href="/web#about">About</Link></li>
                  <li><Link href="/web#plans">Plans</Link></li>
                  <li><Link href="/web#faq">FAQ</Link></li>
                </ul>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="footer_widget">
                <h5>Account</h5>
                <ul className="cta_list">
                  <li><Link href="/web/register">Register</Link></li>
                  <li><Link href="/web/login">Log in</Link></li>
                </ul>
              </div>
            </div>
          </div>
