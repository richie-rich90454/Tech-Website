...
export default async function DashboardPage() {
    ...
    const [totalUsers, totalAttacks, runningAttacks, totalPaidUsers, newsItems, recentLogs] =
        await Promise.all([
            webDb.users.count(),
            webDb.logs.count(),
            webDb.logs.count({
                        ...
                        <div className="card-body">
                            ...
                            <div className="progress progress-md">
                                <div
                                    ...
                                    role="progressbar"
                                    style={{ width: `${Math.min(totalUsers, 100)}%` }}
                                ></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="progress progress-md">
                                <div
                                    ...
                                    role="progressbar"
                                    style={{ width: `${Math.min(totalAttacks, 100)}%` }}
                                ></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="progress progress-md">
                                <div
                                    ...
                                    role="progressbar"
                                    style={{ width: `${Math.min(runningAttacks, 100)}%` }}
                                ></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="progress progress-md">
                                <div
                                    ...
                                    role="progressbar"
                                    style={{ width: `${Math.min(totalPaidUsers, 100)}%` }}
                                ></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="col-lg-12">
                                        {newsItems.length === 0 ? (
                                            ...
                                            newsItems.map((item) => (
                                                <div
                                                    key={item.ID}
                                                    className="d-flex align-items-start border-left-line pb-3"
                                                >
                                                    <div>
                                                        <a
                                                            href="javascript:void(0)"
                                                            className="btn btn-purple btn-circle mb-2 btn-item"
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                width="24"
                                                    ...
                                                    <div className="ml-3 mt-2">
                                                        <h5 className="text-white font-weight-medium mb-2">
                                                            {item.title}
                                                        </h5>
