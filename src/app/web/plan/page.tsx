                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <p className="text-muted text-center mb-4 font-weight-light">
                                            Duration: {plan.length} day
                                            {plan.length !== 1 ? 's' : ''}
                                        </p>
                                        <div className="d-flex align-items-center mb-2">
                                            <p>
                                                <i className="fa fa-minus" aria-hidden="true"></i>{' '}
                                                Max Attack Time: <b>{plan.mbt}s</b>
                                            </p>
                                        </div>
                                        <div className="d-flex align-items-center mb-2">
                                            <p>
                                                <i className="fa fa-minus" aria-hidden="true"></i>{' '}
                                                Concurrents: <b>{plan.concurrents}</b>
                                            </p>
                                        </div>
                                        <div className="d-flex align-items-center mb-2">
                                            <p>
                                                <i className="fa fa-minus" aria-hidden="true"></i>{' '}
                                                <b>Unlimited Attacks</b>
                                            </p>
                                        </div>
                                        <div className="d-flex align-items-center mb-2">
                                            <p>
                                        ...
                                        <a
                                            ...
                                            href="https://t.me/UsdtNL_bot"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            <button
                                                className="btn btn-success btn-border btn-lg w-100 fw-bold mb-3"
                                                type="button"
                                            >
                                                Buy Now
                                            </button>
