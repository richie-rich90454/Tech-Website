            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>{submission.id}</td>
                        <td>
                            <textarea name="Techname" defaultValue={submission.techname} />
                        </td>
                        <td>
                            <textarea name="description" defaultValue={submission.tl1_desc} />
                        </td>
                        <td>
                            <textarea name="description2" defaultValue={submission.tl2_desc} />
                        </td>
                        <td>
                            <textarea name="description3" defaultValue={submission.tl3_desc} />
                        </td>
                        <td>
                            <textarea name="description4" defaultValue={submission.tl4_desc} />
                        </td>
                        <td>
                            <textarea name="Link" defaultValue={submission.link} />
                        </td>
                        <td>
                            <textarea name="display" defaultValue={submission.displaytext} />
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                {DOMAIN_FIELDS.map(({ key, label }) => (
                    <li key={key}>
                        <input
                            type="checkbox"
                            name={key}
                            defaultChecked={domain ? !!domain[key] : false}
                        />
                        <span>{label}</span>
                    </li>
                ))}
