        ...
        <>
            ...
            <div id="subhead">
                ...
                <p className="jump-menu">
                    Jump to: <a href="#tool-name">Tool Name</a>
                    {' · '}
            ...
            <div id="all">
                ...
                >
                    ...
                    <div className="domains">
                        {tl1Domains.map((d) => (
                            <label key={d.name}>
                                <input type="checkbox" name={d.name} value="true" />
                                {d.label}
                            </label>
                        ))}
                    </div>
