    ...
    $(function() {
      function handlelogobg() {
        $(".theme-color .theme-item .theme-link").on("click", function() {
          ...
          $(".topbar .top-navbar .navbar-header").attr("data-logobg", logobgskin != null ? logobgskin : "");
        });
      }
      handlelogobg();
      function handlenavbarbg() {
        ...
        $(".theme-color .theme-item .theme-link").on("click", function() {
          ...
          $("#main-wrapper").attr("data-navbarbg", navbarbgskin != null ? navbarbgskin : "");
          $(".topbar .navbar-collapse").attr("data-navbarbg", navbarbgskin != null ? navbarbgskin : "");
          if ($("#main-wrapper").attr("data-navbarbg") == "skin6") {
            $(".topbar .navbar").addClass("navbar-light");
            $(".topbar .navbar").removeClass("navbar-dark");
          } else {
      ...
      function handlesidebarbg() {
        $(".theme-color .theme-item .theme-link").on("click", function() {
          ...
          $(".left-sidebar").attr("data-sidebarbg", sidebarbgskin != null ? sidebarbgskin : "");
          $(".scroll-sidebar").attr("data-sidebarbg", sidebarbgskin != null ? sidebarbgskin : "");
        });
      }
      handlesidebarbg();
